...
// 11. Используй for-range по строке с Unicode-символами (например, "Привет")
...
// 16. Напиши switch без выражения: по логическим кейсам определи,
// положительное ли число, ноль или отрицательное, и выведи строку.

// 17. Объяви переменную var n int; не присваивай ей значение. С помощью if проверь,
// равна ли она 0 (zero value), и выведи "zero".

// 18. Считай переменную окружения "HOME" через os.Getenv и выведи её значение. Если пусто — выведи "HOME is empty".

// 19. Создай константу pi = 3.14 (типизированную как float64) и выведи её через fmt.Printf
...
// 22. Считай первый аргумент из os.Args (если есть) как строку s.
// Выведи количество байт (len) и количество рун (utf8.RuneCountInString).
...
// 1. Объяви два числа a и b. Найди максимальное и выведи его.

// 2. Объяви три числа. Найди минимальное и выведи его.

// 3. Напиши функцию max(a, b int) int и протестируй её на разных парах чисел.

// func main() {

// 4. Напиши функцию min(a, b int) int и протестируй её на разных парах чисел.

// 5. Объяви массив из 5 чисел. Найди максимальное значение с помощью цикла for.

// 6. Объяви массив из 5 чисел. Найди минимальное значение с помощью цикла for.

// 7. Считай целое n и посчитай факториал n с помощью цикла for. Выведи результат.

// 8. Реализуй функцию factorial(n int) int и протестируй её на n = 0, 1, 5.

// 9. С помощью for посчитай сумму чисел от 1 до 10 и выведи результат.

// 10. С помощью for посчитай сумму чётных чисел от 1 до 20.

// 11. С помощью for посчитай сумму нечётных чисел от 1 до 20.

// 12. Напиши функцию isEven(n int) bool и проверь несколько значений в main.

// 13. Напиши функцию isOdd(n int) bool и проверь несколько значений в main.

// 14. Считай число n. Если оно чётное — выведи "even", иначе — "odd".

// 15. Реализуй цикл for, который суммирует числа от 1 до n, где n = 100. Выведи результат.

// 16. Объяви срез из чисел. Найди максимальный элемент через цикл for.

// 17. Объяви срез из чисел. Найди минимальный элемент через цикл for.

// 18. Реализуй функцию sumSlice([]int) int, возвращающую сумму элементов среза. Протестируй её.

// 19. Объяви переменную n = 10. С помощью for посчитай факториал n и выведи результат.

// 20. С помощью for посчитай количество чётных и количество нечётных чисел в диапазоне от 1 до 50. Выведи оба значения.
